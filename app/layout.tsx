    ...
    <html lang="en">
      ...
      <body className={inter.className}>
        <div className="flex flex-col min-h-screen">
          ...
          <main className="flex-grow pt-[calc(40px+4rem)]"> {/* Adjust this value based on your TopBanner and Navigation heights */}
            {children}
          </main>
          ...
          <PopupAd 
            message1="play and win 2x money"
            linkUrl1="https://stake.com/?c=DwfSNO7Z"
            message2="Check out our special offer!"
            linkUrl2="https://chudaids.com/4/7819903"
          />
        </div>
        <SpeedInsights />

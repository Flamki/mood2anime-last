...
export default function Navigation() {
  ...
  const SocialLinks = () => (
    <div className="flex space-x-4">
      <a href="https://discord.gg/thMY6CYSHw" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300 transition-colors">
      ...
      <a href="https://x.com/Mood2Anime" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300 transition-colors">
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
